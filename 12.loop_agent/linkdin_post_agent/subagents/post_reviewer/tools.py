...
def length_feedback(text: str, tool_context: ToolContext) -> Dict[str, Any]:
    """
    Wrapper function to run character length validation on the LinkedIn post.

    Args:
        text (str): The LinkedIn post to review.
        tool_context (ToolContext): The context used to manage agent state.

    Returns:
        Dict[str, Any]: The result dictionary from the character count tool.
    """
    return count_characters(text, tool_context)